...
MATCHER_P(ImagMatcher, expected, "")
{
  return std::ranges::equal(
    expected, arg, [](const auto& lhs, const auto& rhs) { return std::ranges::equal(lhs, rhs); });
}
}  // namespace
...
TEST(RgbToGrayScaleTest, GivenRGBImageWithOnePixelShouldReturnOnePixelGrayscaleImageWhichIsSumOfWeightedRGBValues)
{
  ...
  const GrayScaleImage outputImage{{static_cast<std::byte>(
    std::to_integer<int>(pixel.r) * RED_FACTOR + std::to_integer<int>(pixel.g) * GREEN_FACTOR +
...
TEST(RgbToGrayScaleTest, GivenRGBImageShouldReturnOneGrayscaleImageWhichIsSumOfWeightedRGBValues)
{
  ...
  const GrayScaleImage outputImage{
    {static_cast<std::byte>(
       std::to_integer<int>(firstPixel.r) * RED_FACTOR + std::to_integer<int>(firstPixel.g) * GREEN_FACTOR +
       std::to_integer<int>(firstPixel.b) * BLUE_FACTOR),
     static_cast<std::byte>(
       std::to_integer<int>(secondTwo.r) * RED_FACTOR + std::to_integer<int>(secondTwo.g) * GREEN_FACTOR +
       std::to_integer<int>(secondTwo.b) * BLUE_FACTOR)},
    {static_cast<std::byte>(
       std::to_integer<int>(thirdThree.r) * RED_FACTOR + std::to_integer<int>(thirdThree.g) * GREEN_FACTOR +
       std::to_integer<int>(thirdThree.b) * BLUE_FACTOR),
     static_cast<std::byte>(
       std::to_integer<int>(fourthPixel.r) * RED_FACTOR + std::to_integer<int>(fourthPixel.g) * GREEN_FACTOR +
